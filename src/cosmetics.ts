...
export const SKINS: Skin[] = [
  ...
  // ===== RARE — classes & undead =====
  { id: "knight", name: "Knight", body: 0x8a93a0, head: 0xc8d2dc, rarity: "rare", cost: 200, hat: "helmet", hatColor: 0xb6c0cc, back: "cape", backColor: 0xb23a3a, pattern: "plate" },
  { id: "wizard", name: "Wizard", body: 0x3a4ea0, head: 0xe8d6c0, rarity: "rare", cost: 210, hat: "wizard", hatColor: 0x3a3a8a, pattern: "runes" },
  ...
  { id: "skeleton", name: "Rattlebones", body: 0xe8e4d8, head: 0xfff8ee, rarity: "rare", cost: 230, hat: "none", pattern: "bones" },
  { id: "mummy", name: "Mummy", body: 0xd8cba0, head: 0xe8dcc0, rarity: "rare", cost: 230, hat: "none", back: "cape", backColor: 0xc8b88a, pattern: "bandage" },
  { id: "robot", name: "Mk-II Bot", body: 0x8a93a0, head: 0xb6c0cc, rarity: "rare", cost: 240, hat: "antenna", hatColor: 0xff5a4a, back: "pack", backColor: 0x5a6270, emblem: 0x6ad7ff, pattern: "circuit" },

  // ===== EPIC — heroes & elements =====
  { id: "astronaut", name: "Astronaut", body: 0xeef1f3, head: 0xbfe2f0, rarity: "epic", cost: 380, hat: "helmet", hatColor: 0xffffff, back: "jetpack", backColor: 0xcfd6dc, pattern: "plate" },
  { id: "samurai", name: "Samurai", body: 0x9a2a2a, head: 0xf0d2c0, rarity: "epic", cost: 390, hat: "helmet", hatColor: 0x2a2a36, back: "cape", backColor: 0x9a2a2a, pattern: "plate" },
  { id: "vampire", name: "Vampire", body: 0x2a1420, head: 0xe8dcea, rarity: "epic", cost: 400, hat: "tophat", hatColor: 0x140a14, back: "cape", backColor: 0x7a1a2a, pattern: "runes" },
  { id: "pumpkin", name: "Pumpkin King", body: 0x3a2a1a, head: 0xff7a2a, rarity: "epic", cost: 400, hat: "crown", hatColor: 0x5a8a2a },
  { id: "cyborg", name: "Cyborg", body: 0x2a3450, head: 0x9fb6ff, rarity: "epic", cost: 410, hat: "visor", hatColor: 0x6ad7ff, back: "jetpack", backColor: 0x3a4660, emblem: 0x6ad7ff, pattern: "circuit" },
  { id: "pharaoh", name: "Pharaoh", body: 0x2a3a8a, head: 0xffd24a, rarity: "epic", cost: 420, hat: "crown", hatColor: 0xffe14a, back: "cape", backColor: 0x2a3a8a, emblem: 0xffe14a, pattern: "runes" },
  { id: "glacier", name: "Glacier", body: 0x6fd0ff, head: 0xffffff, rarity: "epic", cost: 420, hat: "helmet", hatColor: 0xeaf6ff, back: "wings", backColor: 0xbfeaff, pattern: "scales" },
  { id: "inferno", name: "Inferno", body: 0xff4a2a, head: 0xffd24a, rarity: "epic", cost: 430, hat: "horns", hatColor: 0xff7a2a, back: "jetpack", backColor: 0x6f3822, pattern: "scales" },
  { id: "midas", name: "Midas", body: 0xffcf52, head: 0xfff4d6, rarity: "epic", cost: 450, hat: "crown", hatColor: 0xffe14a, back: "cape", backColor: 0xffcf52, emblem: 0xffe14a, pattern: "plate" },
  ...
  { id: "lich", name: "Lich King", body: 0x1a2a3a, head: 0x6ad7c0, rarity: "legendary", cost: 780, glow: 0x6ad7ff, hat: "crown", hatColor: 0x6ad7ff, back: "cape", backColor: 0x1a2a3a, emblem: 0x6ad7ff, pattern: "runes" },
  { id: "dragonlord", name: "Dragonlord", body: 0x2a6a3a, head: 0xc8ff8a, rarity: "legendary", cost: 820, glow: 0x9aff5a, hat: "horns", hatColor: 0x1a4a2a, back: "wings", backColor: 0x2a6a3a, emblem: 0x9aff5a, pattern: "scales" },
  ...
  { id: "cosmic", name: "Cosmic", body: 0x2a1a5e, head: 0xff9ec7, rarity: "mythic", cost: 1300, glow: 0xc792ea, hat: "wizard", hatColor: 0x4a2a8e, back: "wings", backColor: 0xc792ea, emblem: 0xffd24a, pattern: "stars" },
  { id: "prismatic", name: "Prismatic", body: 0xff5a7a, head: 0x6ad7ff, rarity: "mythic", cost: 1500, glow: 0xffd24a, hat: "halo", hatColor: 0xffd24a, back: "wings", backColor: 0xff5a7a, emblem: 0x7be08a, pattern: "stripes" },
  { id: "voidemperor", name: "Void Emperor", body: 0x140a26, head: 0x8a5ad6, rarity: "mythic", cost: 1600, glow: 0x9a5ad6, hat: "crown", hatColor: 0x9a5ad6, back: "cape", backColor: 0x140a26, emblem: 0xc792ea, pattern: "runes" },
  { id: "starseraph", name: "Star Seraph", body: 0xeaf0ff, head: 0x9fe8ff, rarity: "mythic", cost: 1700, glow: 0x7af7ff, hat: "halo", hatColor: 0x7af7ff, back: "wings", backColor: 0xffffff, emblem: 0x7af7ff, pattern: "stars" },
